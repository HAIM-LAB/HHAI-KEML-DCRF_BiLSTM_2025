...
os.environ["TF_NUM_INTEROP_THREADS"] = "50"
os.environ["TF_NUM_INTRAOP_THREADS"] = "50"
import numpy as np
...
def train_DeepCRF(dataset, dataset_name):
    ...
    if vs_code == 1:
        ...
        train_file = "..\\workspace\\2025_ACL_SpeechEMD_proj_code\\" + dataset + ".feat"
    else:
    ...
    # added by Z
    # Add this block to compute precision, recall, f1
    ...
    #save_confusion_matrix(y_test_flat, y_pred, output_path=f"2025_ACL_SpeechEMD_proj_code/report/{dataset_name}_")
